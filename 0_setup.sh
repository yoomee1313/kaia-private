...
modifyNNData()
{
  ...
  do
    ...
    echo $NODE_TYPE$num ": " $PORT $RPC_PORT $WS_PORT
...
#    mv homi-output-tmp/keys/nodekey1 homi-output/keys/nodekey1
#    mv homi-output-tmp/keys/passwd1 homi-output/keys/passwd1
#    mv homi-output-tmp/keys/reward1 homi-output/keys/reward1
#    mv homi-output-tmp/keys/validator1 homi-output/keys/validator1
